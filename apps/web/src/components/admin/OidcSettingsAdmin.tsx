  ...
  return (
    <div className="grid gap-6">
      <Panel className="grid gap-3">
        ...
        <p className="m-0 text-sm text-ink-muted">{t('ssoSettingsBlurb')}</p>
      </Panel>
      ...
      <Panel className="grid gap-4">
        ...
        <div>
          ...
          />
          <p className="m-0 mt-1 text-sm text-ink-muted">{t('ssoJitHint')}</p>
        </div>
        <Field label={t('ssoIssuer')}>
          <Input
            value={issuer}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label={t('ssoClientSecret')}>
            <PasswordInput
              ...
              placeholder={
                hasClientSecret ? t('mailSecretLeaveBlank') : t('ssoClientSecret')
              }
